...
APP_NAME = "RFP-to-Proposal Agent"
APP_SLUG = "rfpproposalapi"
DEFAULT_BASE_URL = "https://rfp-to-proposal-agent.up.railway.app"
...
FOLLOWUP_FROM_EMAIL = os.getenv("FOLLOWUP_FROM_EMAIL", "RFP-to-Proposal Agent <joseph@dataweaveai.com>").strip()
...
STARTER_MONTHLY_COST_CAP_USD = float(os.getenv("STARTER_MONTHLY_COST_CAP_USD", "12.9"))
